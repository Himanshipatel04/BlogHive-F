    ...
    <div className="inria-sans-light h-fit py-52 flex items-center justify-between pr-36 pl-36  ">
      ...
      <div className="flex flex-col items-start gap-8 text-left justify-between -mt-28 w-[750px] h-[250px] ">
        ...
        <div className="flex items-center justify-between gap-10 mt-4">
           <Link target="_blank" to="https://www.linkedin.com/in/mark-zuckerberg-618bba58/"> <img className="h-7 hover:scale-110"  src={linkedin} alt="" /></Link>
           <Link target="_blank" to="https://www.instagram.com/zuck/"> <img className="h-7 hover:scale-110"  src={instagram} alt="" /></Link>
           <Link target="_blank" to="https://twitter.com/finkd"> <img className="h-7 hover:scale-110"  src={twitter} alt="" /></Link>
           <Link target="_blank" to="https://telegram.me/NatGeoAll"> <img className="h-7 hover:scale-110"  src={telegram} alt="" /></Link>
        </div>
      </div>
